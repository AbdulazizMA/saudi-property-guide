...
export default function ContactForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('https://formspree.io/f/xpwzgkby', {
        method: 'POST',
        ...
        body: JSON.stringify({
          ...
          _subject: `Haramain Properties: Inquiry from ${formData.name}`,
        }),
      })
      ...
      if (response.ok) {
        ...
        const mailtoHref = `mailto:${siteConfig.contact.email}?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(body)}`
      ...
      {isSubmitted ? (
        <div className="text-center py-12">
          ...
          <p className="text-gray-600 mb-2">
            Thank you for reaching out. Abdulaziz will get back to you as soon as possible.
          </p>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="Tell me about your property goals — preferred city, budget range, timeline, or any questions..."
            />
          </div>
