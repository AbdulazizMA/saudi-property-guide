...
export default function WhatsAppButton({
  ...
  const variantStyles = {
    primary: 'bg-[#25D366] hover:bg-[#1da851] text-white shadow-lg hover:shadow-xl',
    secondary: 'bg-saudi-gold hover:bg-saudi-gold-dark text-white shadow-lg hover:shadow-xl',
    outline: 'border-2 border-[#25D366] text-[#25D366] hover:bg-[#25D366] hover:text-white',
    white: 'bg-white text-saudi-green hover:bg-gray-100 shadow-lg hover:shadow-xl',
  }
  ...
  return (
    ...
    >
      <WhatsAppIcon className={size === 'lg' ? 'w-6 h-6' : size === 'sm' ? 'w-4 h-4' : 'w-5 h-5'} />
      <span>{children}</span>
    </a>
  )
}
